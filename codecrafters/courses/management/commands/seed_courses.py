...
COURSES = [
    ...
    },
    {
        ...
        "topics": [
            ...
            ("C Operators",                                 5, 50),
            ("Input output",                                6, 50),
            ("conditional_flow_statements",                 7, 50),
            ("Control Flow",                                8, 50),
            ("Control_Flow__Directing_Code",                9, 50),
            ("The Switch Statement",                       10, 50),
            ("The While Loop",                             11, 50),
            ("For Loop",                                   12, 50),
            ("Functions",                                  13, 50),
            ("Arrays",                                     14, 50),
            ("Pointers",                                   15, 50),
            ("String",                                     16, 50),
            ("Structures and Unions",                      17, 50),
            ("Dynamic Memory Allocation",                  18, 50),
            ("File Handling",                              19, 50),
        ],
    },
    {
