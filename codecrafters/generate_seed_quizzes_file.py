...
out_file = "courses/management/commands/seed_python_quizzes.py"
...
with open(out_file, "w", encoding="utf-8") as f:
    ...
    f.write("    help = 'Seeds 22 AI-Generated Quizzes for the Python Masterclass'\n\n")
    ...
    f.write("            topic = Topic.objects.filter(title=title, course__title='Python Masterclass').first()\n")
    f.write("            if topic:\n")
    f.write("                topic.predefined_quiz = quiz\n")
    f.write("                topic.save()\n")
    f.write("                count += 1\n\n")
    f.write("        self.stdout.write(self.style.SUCCESS(f'Successfully re-seeded {count} Python Masterclass quizzes!'))\n")
